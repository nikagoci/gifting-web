      ...
      <div className="flex flex-col justify-center min-h-screen bg-gray-50 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <img
            ...
            alt="Workflow"
          />
          <h2 className="mt-6 text-3xl font-extrabold text-center text-gray-900">Create new account</h2>
        </div>
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <div className="px-4 py-8 bg-white shadow sm:rounded-lg sm:px-10">
            <form className="space-y-6" action="#" method="POST">
              ...
              <Input id="phone" label="Phone number" type="text" required />
              ...
              <div>
                ...
                <div className="text-center">Already have an account? <Link href='/login' className="text-indigo-600 underline">sing in here</Link></div>
                </div>
            </form>
